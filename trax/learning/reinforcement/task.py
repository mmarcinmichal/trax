...
class RLTask:
    ...
    def load_initial_trajectories_from_path(
        ...
        dictionary = training.unpickle_from_store(store, dictionary_file, gzip=False)
        ...
        for epoch in epochs_to_load:
            trajectories = training.unpickle_from_store(
    ...
    def init_from_file(self, file_name):
        ...
        store = board.base.LocalCheckpointStore()
        dictionary = training.unpickle_from_store(store, file_name, gzip=False)
    ...
    def save_to_file(self, file_name):
        ...
        training.pickle_to_store(store, dictionary, file_name, gzip=False)

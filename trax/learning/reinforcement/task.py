...
class RLTask:
    ...
    def load_initial_trajectories_from_path(
        ...
        store = board.base.LocalCheckpointStore()
        dictionary = supervised_trainer.unpickle_from_store(
            store, dictionary_file, gzip=False
        )
        ...
        for epoch in epochs_to_load:
            trajectories = supervised_trainer.unpickle_from_store(
                store, self._epoch_filename(dictionary_file, epoch), gzip=True
            )
    ...
    def init_from_file(self, file_name):
        ...
        store = board.base.LocalCheckpointStore()
        dictionary = supervised_trainer.unpickle_from_store(store, file_name, gzip=False)
        ...
        for epoch in epochs_to_load:
            trajectories = supervised_trainer.unpickle_from_store(
                store, self._epoch_filename(file_name, epoch), gzip=True
            )
    ...
    def save_to_file(self, file_name):
        ...
        for epoch in epochs_to_save:
            supervised_trainer.pickle_to_store(
                store,
        ...
        supervised_trainer.pickle_to_store(store, dictionary, file_name, gzip=False)

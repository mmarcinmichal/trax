...
def _output_dir_or_default_hydra(cfg):
    if FLAGS.output_dir:
        output_dir = FLAGS.output_dir
        logging.info("Using --output_dir %s", output_dir)
        return os.path.expanduser(output_dir)
...
def _train_with_hydra(cfg, output_dir):
    ...
    train(output_dir=output_dir, **train_cfg)
